...
//     divName.classList = simpson.name;
//
//     let divSurname = document.createElement('div');
//     divSurname.classList = simpson.surname;
//
//     let divAge = document.createElement('div');
//     divAge.classList = simpson.age;
//
//     let pInfo = document.createElement('p');
//     pInfo.classList = simpson.info;
//
...
//3. Є масив, створити для кожного елементу масиву свій блок, блок розділити блоками, в яких будуть зберігатись значення окремих властивостей, для властивості modules зробити список з елементами
